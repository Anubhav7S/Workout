...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView(){
        ...
        speakOut("Take a rest for the next 10 seconds, up next" + exerciseList!![currentExercisePosition+1].getName() )
        setRestProgressBar()
    }
    ...
    private fun setRestProgressBar(){
        ...
        restTimer = object : CountDownTimer(restTimerDuration*30000,15000){
    ...
    private fun setExerciseProgressBar(){
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration*1000,1000){
            ...
            override fun onFinish() {
                ...
                //Toast.makeText(this@ExerciseActivity,"Time up, take a rest!",Toast.LENGTH_SHORT).show()
